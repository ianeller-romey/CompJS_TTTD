...
namespace TTTD_Builder.Controls
{
    public class UserControl_BehaviorInstanceDefinition : UserControl
    {
        ...
        private static readonly Regex m_regex_behaviorConstructor = new Regex("\"setBehaviorConstructor\", \"(?<behaviorConstructorName>\\w+)\", (?<behaviorConstructorFunction>\\w+)", RegexOptions.Compiled);
